...
?>
  ...
  <section class="hero-wrap" style="background-image: url('images/landingpage.png');">
    <div class="overlay"></div>
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
        <div class="col-md-7 ftco-animate">
          <h1 class="mb-4" style="color:purple;">About Us</h1>
            ...
            <div class="col-md-6 d-flex">
              <div class="d-flex about-wrap">
                <div class="img d-flex align-items-center justify-content-center"
                  style="background-image:url(images/about-1.png);">
                </div>
              ...
              <div class="row justify-content-start pb-3">
                <div class="col-md-12 heading-section ftco-animate">
                  ...
                  <p>PrepPros is a platform to learn skills that you need for technology jobs. We help you polish your
                    ...
                    professional.</p>
                  <p><a href="login&signup/register.php" class="btn btn-primary">Know More</a></p>
                </div>
              </div>
            </div>
          </div>
