...
<footer class="ftco-footer ftco-no-pt">
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-md pt-5">
          <div class="ftco-footer-widget pt-md-5 mb-4 ml-md-5">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="../resources.php" class="py-2 d-block">Services</a></li>
        ...
        <div class="col-md pt-5">
          <div class="ftco-footer-widget pt-md-5 mb-4">
            <h2 class="ftco-heading-2">Fast Track Courses</h2>
            <ul class="list-unstyled">
              <li><a href="../Courses/Java/abt.php" class="py-2 d-block">Java</a></li>
              <li><a href="../Courses/python/ab.php" class="py-2 d-block">Python</a></li>
              <li><a href="#" class="py-2 d-block">CPP</a></li>
        ...
        <div class="col-md pt-5">
          <div class="ftco-footer-widget pt-md-5 mb-4">
            <h2 class="ftco-heading-2">Have a doubt?</h2>
            <div class="block-23">
              <ul class="list-unstyled">
