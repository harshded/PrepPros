    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {        
            ...
            try {
                ...
                $mail->Body    = 'Here is a link to change the Password <b><a href="http://localhost/preppros/login&signup/reset-password.php?reset='.$code.'">http://localhost/login&signup/reset-password.php?reset='.$code.'</a></b>';
        ...
        $msg = "<div class='alert alert-danger'>$email - This email address can not be found.</div>";
    }
}
