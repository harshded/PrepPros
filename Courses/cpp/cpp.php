            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    ...
                    <a href=" <?php echo $base_url; ?>ide/index.html" target="iframe">Ide</a>
                        ...
                        <li>
                            <a href="cpp_module1.php"    target="iframe" >Module 1</a>
                        </li> 
                        <!-- <li>
                ...
                <li>
                    <a href="cpp_module2.php" target="iframe">Module 2</a>
                </li>
                <li>
                    <li>
                        <a href="cpp_module3.php" target="iframe">Module 3</a>
                    </li>
                </li>
                <li>
                    <a href="cpp_module4.php" target="iframe">Module 4</a>
                </li>
                <li>
                    <a href="cpp_module5.php" target="iframe">Module 5</a>
                </li>
