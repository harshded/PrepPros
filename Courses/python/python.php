            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu"> -->
                        <li>
                            <a href="ab.php"    target="iframe" >Introduction</a>
                        </li> 
                        <li>
                    <a href=" <?php echo $base_url; ?>ide/index.html" target="iframe">Ide</a>
                </li>
                        <li>
                            <a href="module.php"    target="iframe" >Module 1</a>
                        </li> 
                        <!-- <li>
                ...
                <li>
                    <a href="module2.php" target="iframe">Module 2</a>
                </li>
                <li>
                    <li>
                        <a href="module3.php" target="iframe">Module 3</a>
                    </li>
                </li>
                <li>
