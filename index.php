...
<div class="hero-wrap js-fullheight" style="background-image: url('images/h1_hero.png');">

    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
        <div class="col-md-7 ftco-animate">
          <center><span class="subheading">Welcome to PrepPros</span></center>
          <h1 class="mb-4">A New Way to Learn</h1>
          <p class="caps">PrepPros is the best platform to help you enhance your skills, expand your knowledge and
