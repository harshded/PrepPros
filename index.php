...
<div class="hero-wrap js-fullheight" style="background-image: url('images/landingpage.png');">
    ...
    <div class="container">
    <div class="banner" style="color: rgb(65 0 136 / 80%);">
      <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
        <div class="col-md-7 ftco-animate">
          <center><span class="subheading" style="color: rgb(65 0 136 / 80%);">Welcome to PrepPros</span></center>
          <h1 class="mb-4" style="color: rgb(65 0 136 / 80%);">A New Way to Learn</h1>
          <p class="caps" style="color: rgb(65 0 136 / 80%);">PrepPros is the best platform to help you enhance your skills, expand your knowledge and
...
<div class="col-md-3 col-lg-2">
    <a href="#" class="course-category img d-flex align-items-center justify-content-center" style="background-image: url(images/c-sharp.png);">
       <div class="text w-100 text-center">
          <h3>C#</h3>
