...
<head>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   <div class="container">
     <a class="navbar-brand" href="index.html"><span>Prep</span>Pros</a>
   ...
   <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
         <li class="nav-item active"><a href="#Interview Preparation" class="nav-link">Home</a></li>
...
<div class="hero-wrap js-fullheight" style="background-image: url('images/landingpage.png'); color=purple;">

    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
        <div class="col-md-7 ftco-animate">
          <center><span class="subheading" style="color:purple;">Welcome to PrepPros</span></center>
          <h1 class="mb-4" style="color:purple;">A New Way to Learn</h1>
          <p class="caps" style="color:purple;">PrepPros is the best platform to help you enhance your skills, expand your knowledge and
            prepare for technical interviews.</p><br>
          <p class="mb-0" >
            <a href="#" id="Interview Preparation" class="btn btn-white">Get Started For Free </a>
          </p>
...
<section id="courses" class="ftco-section bg-light">
   ...
   <div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
              <div class="course-section__title-container">
                <div class="course-section__title">
                  <center><h3><b style="color: #5400ae;font-size: 30px;;">Fast Track</b> Courses</h3></center> 
                 </div>
    ...
    <div class="row justify-content-center">
     <div class="col-md-3 col-lg-2">
        <a href="#" class="course-category img d-flex align-items-center justify-content-center" style="background-image: url(images/python.png);">
  ...
  <div class="col-md-3 col-lg-2">
    <a href="#" class="course-category img d-flex align-items-center justify-content-center" style="background-image: url(images/java.jpeg);">
       <div class="text w-100 text-center">
          <h3>Java</h3>
...
<div class="col-md-3 col-lg-2">
    <a href="#" class="course-category img d-flex align-items-center justify-content-center" style="background-image: url(images/c++.jpeg);">
       <div class="text w-100 text-center">
          <h3>C++</h3>
...
<div class="col-md-3 col-lg-2">
    <a href="#" class="course-category img d-flex align-items-center justify-content-center" style="background-image: url(images/c.webp);">
       <div class="text w-100 text-center">
          <h3>C</h3>
...
<div class="course-section__title">
  <br>
  <h3><b style="color: #ae5e00;font-size: 30px;;">PrepPros</b> built using</h3>
</div>
<hr style="width:8px;border-top-color:#eb9e22;border-top: 0.8rem solid #ffe6bd; border-right: 21rem solid transparent;">
</div>
...
We also get you connected with the right mentors worldwide based on your skills and preferences, and do everything needed to make sure you get your dream job.</p>
